...
## 13. Rednote/Xiaohongshu (dots.llm1)

📖 **Full deep-dive available in: [`llm-chinese-rednote.md`](llm-chinese-rednote.md)**

Quick summary: Rednote/Xiaohongshu (小红书, founded 2013) is China's leading social e-commerce platform (Instagram + Pinterest) that launched dots.llm1 foundation model in 2025. Represents platform companies entering AI infrastructure. Features dots.llm1 (142B total, 14B active MoE) achieving **4x training efficiency** vs Qwen2.5-72B (1.46M vs 6.12M GPU hours), MIT licensed, beats Qwen2.5-72B on HumanEval coding. Founded by Miranda Qu and Billy Chen with $3B+ valuation, backed by Sequoia and Hillhouse Capital. Known for exceptional efficiency focus and practical innovation over headline metrics
