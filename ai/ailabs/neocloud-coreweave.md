...
- Proven execution: $25M revenue (2022) → $1.9B revenue (2024) = 76x growth in 2 years
...
- Creates flywheel: scale → reliability → large customers → more scale
...
- Performance improvements compound over time (BlueField-4 → BlueField-5)
...
- **Go-to-Market:** Partnership with scientific computing ISVs (Schrödinger, Gromacs)
...
- **2025:** $5B revenue ≈ 10% of neocloud market, <5% of total AI infrastructure
- **2027:** $18B revenue ≈ 15-20% of neocloud market, 5-8% of total AI infrastructure
...
3. **Proven Scale:** $25M (2022) → $1.9B (2024) revenue, 76x growth in 2 years
...
- **Risks:** Customer concentration, debt burden, execution challenges, stock volatility ($40 IPO → $187 peak → $77-105 current)
