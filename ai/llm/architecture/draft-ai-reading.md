...
| Pallas Design — JAX documentation | Documentation | JAX | [Link](https://docs.jax.dev/en/latest/pallas/design/design.html) |
| Autodidax: JAX core from scratch — JAX documentation | Tutorial | JAX | [Link](https://docs.jax.dev/en/latest/autodidax.html) |
