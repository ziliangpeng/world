...
- [Context Windows](../../architectural-patterns/context-windows.md) - Architecture fundamentals
- [Position Embeddings](../../architectural-patterns/position-embeddings.md) - RoPE and alternatives
